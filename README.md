...
### 디스크 쿼터
>   \- 파일시스템마다 사용자나 그룹이 생성할 수 있는 파일의 용량 및 개수를 제한하기 위하여 사용   
> - **quota**   
...
>   \- /etc/yum.repos.d : yum 명령의 저장소 관련 파일들이 위치하는 디렉토리   
...
> - **IPv6**   
>   \- IP 주소 비트수 : 128비트   
>   \- IP 주소 방식 : 자동 설정 주소 방식
>   \- IP 헤더 길이 : 40바이트(기본헤더)와 확장필드 이용   
